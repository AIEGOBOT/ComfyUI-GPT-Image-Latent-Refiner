...
> ### 원본 보존을 우선하는 SeedVR2 업스케일
>
> 일반적인 Hires Fix가 확산 샘플링을 한 차례 더 수행하는 것과 달리, 이 워크플로우는
> SeedVR2 복원으로 업스케일합니다. 목표 해상도에서 디테일을 재구성하면서 원본의
> 구도·인물 정체성·형태를 가능한 한 유지하도록 설계했습니다. SeedVR2도 미세
> 디테일을 재해석할 수 있으므로 중요한 이미지에는 전후 비교를 권장합니다.
